...
public class StockController {
    ...
    // 재고 조회
    @Operation(summary = "재고 조회", description = "로그인한 회사만 자신이 등록한 제품의 재고를 조회할 수 있습니다.",
    ...
    // 입고
    @Operation(summary = "재고 입고", description = "제품에 대해 재고 입고를 처리합니다.",
            security = @SecurityRequirement(name = "jwtAuth"))
    ...
    // 출고
    @Operation(summary = "재고 출고", description = "제품에 대해 재고 출고를 처리합니다.",
            security = @SecurityRequirement(name = "jwtAuth"))
    ...
    // 수량 증가
    @Operation(summary = "재고 수량 증가", description = "수량을 단순 증가시킵니다.",
            security = @SecurityRequirement(name = "jwtAuth"))
    ...
    // 수량 감소
    @Operation(summary = "재고 수량 감소", description = "수량을 단순 감소시킵니다.",
            security = @SecurityRequirement(name = "jwtAuth"))
    ...
    // 품절 처리
    @Operation(summary = "품절 처리", description = "제품을 품절 상태로 변경합니다.",
            security = @SecurityRequirement(name = "jwtAuth"))
